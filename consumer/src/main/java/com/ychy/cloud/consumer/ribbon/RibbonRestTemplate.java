...
/**
 * 根据RestTemplate特性自己改造RibbonRestTemplate
 * 适用于spring boot还没有加载Ribbon时无法使用RestTemplate时使用该自定义RestTemplate
 */
@Slf4j
public class RibbonRestTemplate extends RestTemplate {
    ...
    public RibbonRestTemplate (DiscoveryClient discoveryClient) {
